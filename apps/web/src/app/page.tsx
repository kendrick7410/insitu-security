...
export default function HomePage() {
  return (
    <main className="h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth">
      ...
      {/* Section 1 - Hero */}
      <section className="h-screen snap-start flex items-center justify-center bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-6xl w-full text-center px-4">
          ...
          {/* Slogan */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-700 tracking-tight leading-tight mb-16">
          ...
          <div className="animate-bounce">
            ...
            <p className="text-sm text-gray-500 mt-2">Découvrir</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl w-full text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white rounded-xl p-6 hover:shadow-xl transition-shadow">
              ...
              <h3 className="font-bold text-lg mb-2">Caméras</h3>
              <p className="text-sm text-gray-600">HD & 4K</p>
            </div>

            <div className="bg-white rounded-xl p-6 hover:shadow-xl transition-shadow">
              <div className="text-5xl mb-3">🚪</div>
              <h3 className="font-bold text-lg mb-2">Capteurs</h3>
              <p className="text-sm text-gray-600">Ouverture & Mouvement</p>
            </div>

            <div className="bg-white rounded-xl p-6 hover:shadow-xl transition-shadow">
              <div className="text-5xl mb-3">🏠</div>
              <h3 className="font-bold text-lg mb-2">Centrale</h3>
              <p className="text-sm text-gray-600">Hub connecté</p>
            </div>

            <div className="bg-white rounded-xl p-6 hover:shadow-xl transition-shadow">
              <div className="text-5xl mb-3">🔔</div>
              <h3 className="font-bold text-lg mb-2">Sirène</h3>
              <p className="text-sm text-gray-600">120dB extérieure</p>
            </div>
          </div>
      ...
      <section className="h-screen snap-start flex items-center justify-center bg-gradient-to-b from-yellow/5 to-white px-4">
        <div className="max-w-4xl w-full text-center">
          ...
          <div className="bg-gradient-to-br from-orange/10 to-yellow/10 rounded-2xl p-8 md:p-12 mb-8 border-2 border-orange/20">
            ...
            <ul className="text-left max-w-md mx-auto space-y-3 mb-8">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-700">Visualisation instantanée sur votre téléphone</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                <span className="text-gray-700">Testez différents emplacements</span>
              </li>
              <li className="flex items-start space-x-3">
                <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-1" />
                <span className="text-gray-700">Ajoutez directement au panier</span>
              </li>
            </ul>
          </div>
      ...
      {/* Section 5 - CTA Final */}
      <section className="h-screen snap-start flex items-center justify-center bg-gradient-to-b from-white to-orange/10 px-4">
        <div className="max-w-4xl w-full text-center">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center mb-12">
            ...
            <Link
              href="/about"
              className="w-full md:w-auto inline-flex items-center justify-center space-x-2 bg-white border-2 border-orange text-orange px-8 py-4 rounded-xl font-bold text-lg hover:shadow-xl transition-all hover:scale-105"
            >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Matériel de qualité</p>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange mb-2">DIY</div>
              <p className="text-gray-600">Installation autonome</p>
            </div>
            <div className="text-center">
